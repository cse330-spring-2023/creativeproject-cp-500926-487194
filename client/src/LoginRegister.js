...
function DatabaseAdd(props){
    ...
    useEffect(() => {
        let que = axios.get("https://api.spotify.com/v1/me", {
          headers: {
        ...
        // ERROR: 404 error
        let topSongs = axios.get("https://api.spotify.com/v1/me/top", {
          headers:{
            'Authorization' : `Bearer ${props.token}`
          },
          params:{
        ...
        axios.post('http://localhost:1234/api/newuser', { userId: userId, displayName: displayName, songId: ids, songTitle: titles, songArtist: artist, songAlbum: album});
